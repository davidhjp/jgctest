...
public class runneromp{
  ...
  private static int meters_thread_2;//stbench/runner.sysj line: 16, column: 5
  private static int u_thread_5;//stbench/runner.sysj line: 63, column: 7
  private static int seconds_thread_3;//stbench/runner.sysj line: 33, column: 4
  ...
  meters_thread_2 = 0;//stbench/runner.sysj line: 16, column: 5
  return false;
}
  public boolean MethodCall2_0(){
  u_thread_5 = 0;//stbench/runner.sysj line: 63, column: 7
  return false;
}
  ...
  ;//stbench/runner.sysj line: 19, column: 2
  return false;
}
  ...
  meters_thread_2 = meters_thread_2 + 1;//stbench/runner.sysj line: 27, column: 8
  return false;
}
  public boolean MethodCall7_0(){
  ;//stbench/runner.sysj line: 17, column: 5
  return false;
}
  ...
  ;//stbench/runner.sysj line: 35, column: 6
  return false;
}
  public boolean MethodCall10_0(){
  seconds_thread_3 = seconds_thread_3 + 1;//stbench/runner.sysj line: 44, column: 5
  return false;
}
  ...
  ;//stbench/runner.sysj line: 64, column: 7
  return false;
}
  ...
  u_thread_5 = u_thread_5 + 1;//stbench/runner.sysj line: 76, column: 4
  return false;
}
